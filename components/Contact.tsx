  ...
  return (
    <section id="contact" className="py-16 text-center">
      <ScrollReveal>
        ...
        <a href="mailto:jose.mejias@example.com" className="inline-flex items-center justify-center px-10 py-5 bg-[var(--color-text-primary)] text-[var(--color-surface)] font-bold rounded-full text-lg transition-all hover:scale-105 active:scale-95 shadow-xl hover:shadow-2xl">
          Get in Touch
        </a>
      </ScrollReveal>
    </section>
